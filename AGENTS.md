# AGENTS.md — platform-notifications

Repository `platform-notifications` in the frasermolyneux organization. Adapt this brief with repo-specific scope and validation commands.
